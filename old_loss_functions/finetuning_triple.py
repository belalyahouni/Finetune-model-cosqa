...
training_args = SentenceTransformerTrainingArguments(
    output_dir="fine_tuned_model_triple",
    num_train_epochs=2,
    learning_rate=1e-5,
    warmup_steps=1000,
...
# Train
trainer.train()
print("Fine-tuning complete! Model saved to 'fine_tuned_model_triple'.")
...
plt.tight_layout()
plt.savefig("training_loss_triple.png", dpi=300)
plt.show()
print("Loss curve saved to 'training_loss_triple.png'.")
